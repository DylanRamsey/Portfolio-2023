...
const ExperienceTabs = () => {
  ...
  return (
    <div className='container mx-auto mb-20 px-6 xl:px-0'>
      <h2 className='text-3xl lg:text-6xl text-center mb-8 lg:mb-16'>My Experience</h2>
      <div className='flex justify-center'>
        <Box className='lg:flex border-[3px] rounded-[20px] w-[853px] he-full lg:h-[317px] shadow-xl' id="experienceTabs">
          <Tabs
